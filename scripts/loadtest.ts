...
const OVERALL_RATE = process.env.LOAD_RPS
  ? Number(process.env.LOAD_RPS)
  : undefined;

const SOURCES = [
  {
    url: "shopee",
    secret: process.env.WEBHOOK_SECRET_SHOPEE ?? "dev-secret-shopee",
  },
  {
    url: "tokopedia",
    secret: process.env.WEBHOOK_SECRET_TOKOPEDIA ?? "dev-secret-tokopedia",
  },
  {
    url: "meta_ads",
    secret: process.env.WEBHOOK_SECRET_META_ADS ?? "dev-secret-meta",
  },
